...
category_lists = []
  ...
  category_lists << ["Video Games", "Electronic Gadgets", "Board Games", "Things that use a Remote", "Card Games", "Internet Lingo", "Offensive Words", "Wireless Thigns", "Computer Parts", "Software", "Websites", "Game Terms"]
  ...
  category_lists << ["Kinds of soup", "Things found in New York", "Things you get tickets for", "Things you do at work", "Foreign words used in English", "Thigns you shouldn't touch", "Spicy Foods", "Things at a Carnival", "Things You Make", "Places to Hangout", "Animal Noises", "Computer Programs"]
